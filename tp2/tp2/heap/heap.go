...
func upheap[T any](arreglo []T, hijo int, funcion_cmp func(T, T) int) {
	if funcion_cmp(arreglo[hijo], arreglo[0]) == 0 {
		return
	}
	padre := (hijo - 1) / 2
...
func downheap[T any](arreglo []T, padre int, funcion_cmp func(T, T) int, cantidad int) {
...
func heapify[T any](arreglo []T, padre int, funcion_cmp func(T, T) int, cantidad int) {
	for padre >= 0 {
